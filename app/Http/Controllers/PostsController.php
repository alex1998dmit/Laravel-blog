...
//        dd($request->all());
    ...
    public function destroy($id)
    {
        ...
        Session::flash('success', 'That was just trashed');
    ...
    public function trashed() {
        ...
        return view('admin.posts.trashed')->with('post', $posts);
    ...
    public function kill($id) {
        ...
        Session::flash('success', 'Post deleted finally');
    ...
    public function restore($id) {
        ...
        Session::flash('success', 'Post restored successufully');
